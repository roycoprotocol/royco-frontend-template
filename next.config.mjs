  ...
  rewrites: async () => {
    ...
    return [
      ...
      },
      {
        ...
        // destination: getRandomRPC([
        //   process.env.RPC_API_KEY_21000000_1,
        //   process.env.RPC_API_KEY_21000000_2,
        //   process.env.RPC_API_KEY_21000000_3,
        //   process.env.RPC_API_KEY_21000000_4,
        //   process.env.RPC_API_KEY_21000000_5,
        // ]),
      },
      {
