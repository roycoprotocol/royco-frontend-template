...
export class Api<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
   ...
   * @secure
   */
  tokenControllerGetTokenDirectory = (data?: TokenDirectoryRequestBody, params: RequestParams = {}) =>
   ...
   * @secure
   */
  marketControllerCreateMarket = (data: CreateMarketBody, params: RequestParams = {}) =>
