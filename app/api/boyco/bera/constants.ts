export const BERA_AIRDROP_ADDRESS = {
  80069: process.env.BERA_AIRDROP_CONTRACT_ADDRESS_80069 as `0x${string}`,
  80094: process.env.BERA_AIRDROP_CONTRACT_ADDRESS_80094 as `0x${string}`,
};

export const BERA_AIRDROP_ABI = [
  {
    type: "receive",
    ...
    inputs: [
      {
        name: "_claims",
        type: "tuple[]",
        internalType: "struct Common.Claim[]",
        components: [
          {
            name: "identifier",
            type: "bytes32",
