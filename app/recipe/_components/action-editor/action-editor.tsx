      ...
      >
        <div className="flex flex-row items-center justify-between">
          <div className="flex flex-row items-center gap-2">
             ...
             * @note Action Index
             */}
            <div className="bg-_brand_custom_cherry_ flex h-7 w-7 flex-col items-center justify-center text-base text-white">
         ...
         */}
        <div className="mt-3 grid h-6 grid-cols-12 gap-1">
          <div className="col-span-1 flex h-6 flex-col items-center justify-center bg-_secondary_ text-center text-white">
            CALL
          </div>
          ...
          {[
            ...
            <div
              ...
              className={cn(
                "col-span-2 flex h-6 cursor-pointer flex-col items-center justify-center bg-_surface_tertiary hover:opacity-80",
          ...
          {action.callType === RecipeActionCallType.CALL &&
            action.stateMutability === "payable" && (
              <Input
                containerClassName="bg-_surface_tertiary rounded-none h-6 text-xs col-span-5 px-2 border-none"
                className=""
        ...
        <div className="mt-3 flex w-full flex-col items-center justify-between gap-1">
          {action.inputs.length > 0 && (
            <div className="grid w-full grid-cols-12 items-start gap-1">
              <div className="col-span-1 flex h-6 flex-col items-center justify-center bg-_brand_bronze_ text-center text-white">
                INPUTS
              </div>

              <div className="col-span-11 flex h-fit flex-1 grow flex-col gap-1">
                {action.inputs.map((input, inputIndex) => (
                  <div
                    key={inputIndex}
                    className="flex flex-row items-center gap-1"
                  >
                    <div className="flex h-6 w-9 shrink-0 flex-col items-center justify-center bg-_surface_tertiary text-_primary_">
                    ...
                    <div className="h-6 w-32 shrink-0 place-content-center overflow-hidden truncate text-ellipsis bg-_surface_tertiary px-2 text-center text-_primary_">
                      {input.name ?? "Unknown"}
                    </div>
                    ...
                    <ActionInput
                      recipeIndex={actionIndex}
                      actionIndex={inputIndex}
                    />
                  </div>
                ))}
              </div>
