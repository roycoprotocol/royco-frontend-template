...
import { PointRewardsColumnDataElement } from "./point-rewards-columns";
...
export const PointRewardsPagination = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> & {
    table: TableInstance<PointRewardsColumnDataElement>;
  }
