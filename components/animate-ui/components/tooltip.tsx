...
function TooltipArrow({ side }: TooltipArrowProps) {
  return (
    <div
      className={cn(
        "absolute z-50 size-2.5 rotate-45 rounded-none bg-primary",
        ...
        <TooltipPortal>
          ...
          >
            <motion.div
              ...
              transition={transition}
              className="relative w-fit text-balance rounded-none bg-primary fill-primary px-3 py-1.5 text-sm text-white shadow-md "
            >
