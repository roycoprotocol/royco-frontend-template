...
function TabsList({
  ...
  return (
    <MotionHighlight
      controlledItems
      className={cn(
        "rounded-sm bg-white shadow-sm dark:bg-slate-950",
        activeClassName
      )}
      value={activeValue}
      transition={transition}
    >
      <TabsPrimitive.List
        ...
        data-slot="tabs-list"
        className={cn(
          "bg-muted inline-flex h-10 w-fit items-center justify-center rounded-lg p-[4px] text-slate-500 dark:text-slate-400",
          className
        )}
        {...props}
      >
